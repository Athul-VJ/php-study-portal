...
margin-left: 50%;
color: #002e5e;">
        <form class="row g-3" action="forgetone.php" method="post">
  <div class="col-auto">
...
border: 1px #ffcf06 solid;">
  ...
  <div class="col-auto">
    <p id="demoo">Name</p>
    <input type="text" class="form-control" id="email" placeholder="Name" name="Name" onkeypress="return (event.charCode > 64 && 
event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" maxlength="10" required>
  </div>
  <div class="col-auto">
