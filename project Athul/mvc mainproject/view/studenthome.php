...
margin-top: 9px;
margin-left: 15px;"><?= $_SESSION['username'] ?></p></b>
                </div>
           
    <div class="col-sm-10 form-group">
         <form action="../controller/statusAction.php" method="post">
      <label for="comment">Comment:</label>
      <textarea class="form-control" rows="2" id="comment" name="status" required></textarea><button type="submit" class="btn btn-primary">Post</button> 
             <a style="color:blue;" class="pointer" data-toggle="modal" data-target="#myModal">upload image</a>
         ...
         <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <form action="../controller/imgUploadAction.php" method="post" name="addfrm" enctype="multipart/form-data">
  <div class="form-group">
    <label for="exampleFormControlFile1">upload image</label>
    <input type="file" name="Image" class="form-control-file" id="exampleFormControlFile1" required>
  </div> <hr>
                         <textarea class="form-control" rows="2" id="comment" name="status" placeholder="Say Something About This..."></textarea> <br><button type="submit" class="btn btn-primary mb-2" style="margin-left: 24px;
    font-style: italic;
">post</button>
</form>
...
">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
        ...
        {?>
          ...
          <a href="../controller/mesgAction.php?id=<?= $roww['id'] ?>"><p><small>you have messages from</small> <?= $roww['id'] ?></p></a><hr><br>
          <?php
  ...
  <h4 class="alert-heading">Posted By <a href="detailview.php?id=<?= $row['name'] ?>"> <?= $row['name'] ?></a></h4><small><?= $row['date'] ?></small><br>
  ...
  <hr>
   <form class="form-inline" method="post" action="../controller/replayAction.php?idid=<?php echo $row['id']; ?>">
