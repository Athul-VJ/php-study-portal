      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link " href="#" >Usefull websites</a>
            </li>
...
">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
          ...
          <form method="post" action="../controller/StudentDetailviewAction.php">
              <div class="row">
...
margin-left: 27px;" alt="warn" class="rounded-circle">
    ...
    <textarea name="message" style="border-radius: 14px;" class="form-control" id="exampleFormControlTextarea1" rows="1" required></textarea>
  </div>
         <div class="form-group">
  ...
  <?php  }
    ...
    <hr>
        ...
        <footer class="bg-light text-center text-lg-start">
          ...
          <!-- Copyright -->
          <div class="text-center p-3 col-md-12" style="background-color: rgba(0, 0, 0, 0.2)">
            since@2020:
